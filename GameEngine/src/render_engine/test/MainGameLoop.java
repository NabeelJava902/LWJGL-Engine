...
import render_engine.entities.Camera;
import render_engine.entities.Entity;
import render_engine.entities.Light;
import render_engine.entities.Player;
import render_engine.guis.GuiRenderer;
import render_engine.guis.GuiTexture;
...
import render_engine.render.DisplayManager;
import render_engine.render.Loader;
import render_engine.render.MasterRenderer;
import render_engine.terrains.Terrain;
import render_engine.textures.ModelTexture;
import render_engine.textures.TerrainTexture;
import render_engine.textures.TerrainTexturePack;
import render_engine.toolBox.entityBuilder;
...
public class MainGameLoop {
	...
	public static void main(String[] args) {
		...
		lights.add(new Light(new Vector3f(370, 17, 500), new Vector3f(0, 0, 2), new Vector3f(1, 0.01f, 0.002f)));
		lights.add(new Light(new Vector3f(293, 7, 450), new Vector3f(2, 0, 0), new Vector3f(1, 0.01f, 0.002f)));

		List<Entity> entities = new ArrayList<>();

		Entity dragon = entityBuilder.buildOBJEntity("dragon/dragon", "dragon/white", 10, 1, false, new Vector3f(300, 50, 300), 0, 0, 0, 10);
		entities.add(dragon);
